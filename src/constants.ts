export const MASTER_GIFTS = [
  ...
  { name: 'Pares de calcetines/soquetes', category: 'Ropa', isReserved: false, isRepeatable: true, quantityNeeded: 6, quantityReserved: 0, price: 7990 },
  ...
  { name: 'Mantas/Cobitas (ligera y gruesa)', category: 'Ropa', isReserved: false, isRepeatable: true, quantityNeeded: 2, quantityReserved: 0, price: 15990 },
...
export const MASTER_TASKS = [
  ...
  { title: 'Bodies/Conjuntos (apertura frontal)', category: 'Bebé', phase: 'Mid', priority: 'High', isCompleted: false },
  ...
  { title: 'Pares de calcetines/soquetes', category: 'Bebé', phase: 'Mid', priority: 'Medium', isCompleted: false },
  { title: 'Tutos (Paños de gasa)', category: 'Bebé', phase: 'Mid', priority: 'High', isCompleted: false },
  { title: 'Mantas/Cobitas (ligera y gruesa)', category: 'Bebé', phase: 'Mid', priority: 'Medium', isCompleted: false },
  ...
  { title: 'Calentador de mamaderas', category: 'Casa', phase: 'Mid', priority: 'Medium', isCompleted: false },
  ...
  // Alimentación
  { title: 'Mamaderas (2-3 unidades)', category: 'Alimentación', phase: 'Mid', priority: 'High', isCompleted: false },
  ...
  { title: 'Chupones/Bobos', category: 'Alimentación', phase: 'Mid', priority: 'Low', isCompleted: false },
  // Hospital
  { title: '3 Camisones (apertura frontal)', category: 'Hospital', phase: 'Late', priority: 'High', isCompleted: false },
  { title: 'Bata y pantuflas/chinelas', category: 'Hospital', phase: 'Late', priority: 'Medium', isCompleted: false },
  ...
  { title: '2 Gorritos y calcetines/soquetes', category: 'Hospital', phase: 'Late', priority: 'High', isCompleted: false },
